...
public class BookPackage extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BookPackage frame = new BookPackage("Harsh_Sharma");
	...
	public BookPackage(String username) {
		...
		contentPane.add(l5);
                ...
                try{
                    ...
                    ResultSet rs = d.s.executeQuery("select * from customer where username = '"+username+"'");
                    while(rs.next()){
