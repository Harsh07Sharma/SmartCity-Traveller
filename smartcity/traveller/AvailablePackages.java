...
public class AvailablePackages extends JFrame{
    public static void main(String[] args) {
      new AvailablePackages("").setVisible(true);
    }

    AvailablePackages(String username) {    
